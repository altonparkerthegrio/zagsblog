		...
		ed.addButton( 'eltd_shortcodes', {
			...
			menu: [
				...
				},
				{
					text: 'Ordered List',
					onclick: function() {
						ed.insertContent('[eltd_list_ordered]<ol><li>Lorem Ipsum</li><li>Lorem Ipsum</li><li>Lorem Ipsum</li></ol>[/eltd_list_ordered]');
					}
				},
				{
					text: 'Separator',
