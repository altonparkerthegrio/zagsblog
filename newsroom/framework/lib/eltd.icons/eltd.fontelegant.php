...
class NewsroomElatedIconsFontElegant implements iNewsroomElatedIconCollection
{
    ...
    private function setSocialIconsArray() {
        ...
        $this->socialIcons = array(
            '' => '',
            'social_blogger' => esc_html__('Blogger', 'newsroom'),
            'social_blogger_circle' => esc_html__('Blogger circle', 'newsroom'),
            'social_blogger_square' => esc_html__('Blogger square', 'newsroom'),
            'social_delicious' => esc_html__('Delicious', 'newsroom'),
            'social_delicious_circle' => esc_html__('Delicious circle', 'newsroom'),
            'social_delicious_square' => esc_html__('Delicious square', 'newsroom'),
            'social_deviantart' => esc_html__('Deviantart', 'newsroom'),
            'social_deviantart_circle' => esc_html__('Deviantart circle', 'newsroom'),
            'social_deviantart_square' => esc_html__('Deviantart square', 'newsroom'),
            'social_dribbble' => esc_html__('Dribbble', 'newsroom'),
            'social_dribbble_circle' => esc_html__('Dribbble circle', 'newsroom'),
            'social_dribbble_square' => esc_html__('Dribbble square', 'newsroom'),
            'social_facebook' => esc_html__('Facebook', 'newsroom'),
            'social_facebook_circle' => esc_html__('Facebook circle', 'newsroom'),
            'social_facebook_square' => esc_html__('Facebook square', 'newsroom'),
            'social_flickr' => esc_html__('Flickr', 'newsroom'),
            'social_flickr_circle' => esc_html__('Flickr circle', 'newsroom'),
            'social_flickr_square' => esc_html__('Flickr square', 'newsroom'),
            'social_googledrive' => esc_html__('Googledrive', 'newsroom'),
            'social_googledrive_alt2' => esc_html__('Googledrive alt2', 'newsroom'),
            'social_googledrive_square' => esc_html__('Googledrive square', 'newsroom'),
            'social_googleplus' => esc_html__('Googleplus', 'newsroom'),
            'social_googleplus_circle' => esc_html__('Googleplus circle', 'newsroom'),
            'social_googleplus_square' => esc_html__('Googleplus square', 'newsroom'),
            'social_instagram' => esc_html__('Instagram', 'newsroom'),
            'social_instagram_circle' => esc_html__('Instagram circle', 'newsroom'),
            'social_instagram_square' => esc_html__('Instagram square', 'newsroom'),
            'social_linkedin' => esc_html__('Linkedin', 'newsroom'),
            'social_linkedin_circle' => esc_html__('Linkedin circle', 'newsroom'),
            'social_linkedin_square' => esc_html__('Linkedin square', 'newsroom'),
            'social_myspace' => esc_html__('Myspace', 'newsroom'),
            'social_myspace_circle' => esc_html__('myspace circle', 'newsroom'),
            'social_myspace_square' => esc_html__('myspace square', 'newsroom'),
            'social_picassa' => esc_html__('Picassa', 'newsroom'),
            'social_picassa_circle' => esc_html__('Picassa circle', 'newsroom'),
            'social_picassa_square' => esc_html__('Picassa square', 'newsroom'),
            'social_pinterest' => esc_html__('Pinterest', 'newsroom'),
            'social_pinterest_circle' => esc_html__('Pinterest circle', 'newsroom'),
            'social_pinterest_square' => esc_html__('Pinterest square', 'newsroom'),
            'social_rss' => esc_html__('Rss', 'newsroom'),
            'social_rss_circle' => esc_html__('Rss circle', 'newsroom'),
            'social_rss_square' => esc_html__('Rss square', 'newsroom'),
            'social_share' => esc_html__('Share', 'newsroom'),
            'social_share_circle' => esc_html__('Share circle', 'newsroom'),
            'social_share_square' => esc_html__('Share square', 'newsroom'),
            'social_skype' => esc_html__('Skype', 'newsroom'),
            'social_skype_circle' => esc_html__('Skype circle', 'newsroom'),
            'social_skype_square' => esc_html__('Skype square', 'newsroom'),
            'social_spotify' => esc_html__('Spotify', 'newsroom'),
            'social_spotify_circle' => esc_html__('Spotify circle', 'newsroom'),
            'social_spotify_square' => esc_html__('Spotify square', 'newsroom'),
            'social_stumbleupon_circle' => esc_html__('Stumbleupon circle', 'newsroom'),
            'social_stumbleupon_square' => esc_html__('Stumbleupon square', 'newsroom'),
            'social_tumbleupon' => esc_html__('Stumbleupon', 'newsroom'),
            'social_tumblr' => esc_html__('Tumblr', 'newsroom'),
            'social_tumblr_circle' => esc_html__('Tumblr circle', 'newsroom'),
            'social_tumblr_square' => esc_html__('Tumblr square', 'newsroom'),
            'social_twitter' => esc_html__('Twitter', 'newsroom'),
            'social_twitter_circle' => esc_html__('Twitter circle', 'newsroom'),
            'social_twitter_square' => esc_html__('Twitter square', 'newsroom'),
            'social_vimeo' => esc_html__('Vimeo', 'newsroom'),
            'social_vimeo_circle' => esc_html__('Vimeo circle', 'newsroom'),
            'social_vimeo_square' => esc_html__('Vimeo square', 'newsroom'),
            'social_wordpress' => esc_html__('WordPress', 'newsroom'),
            'social_wordpress_circle' => esc_html__('WordPress circle', 'newsroom'),
            'social_wordpress_square' => esc_html__('WordPress square', 'newsroom'),
            'social_youtube' => esc_html__('Youtube', 'newsroom'),
            'social_youtube_circle' => esc_html__('Youtube circle', 'newsroom'),
            'social_youtube_square' => esc_html__('Youtube square', 'newsroom'),
        );
    }
