...
class NewsroomElatedSimpleLineIcons implements iNewsroomElatedIconCollection
{
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            '' => '',
            'icon-social-tumblr' => esc_html__('Tumblr', 'newsroom'),
            'icon-social-twitter' => esc_html__('Twitter', 'newsroom'),
            'icon-social-facebook' => esc_html__('Facebook', 'newsroom'),
            'icon-social-instagram' => esc_html__('Instagram', 'newsroom'),
            'icon-social-linkedin' => esc_html__('LinkedIn', 'newsroom'),
            'icon-social-pintarest' => esc_html__('Pinterest', 'newsroom'),
            'icon-social-github' => esc_html__('Github', 'newsroom'),
            'icon-social-gplus' => esc_html__('Google Plus', 'newsroom'),
            'icon-social-reddit' => esc_html__('Reddit', 'newsroom'),
            'icon-social-skype' => esc_html__('Skype', 'newsroom'),
            'icon-social-dribbble' => esc_html__('Dribbble', 'newsroom'),
            'icon-social-behance' => esc_html__('Behance', 'newsroom'),
            'icon-social-foursquare' => esc_html__('Foursquare', 'newsroom'),
            'icon-social-soundcloud' => esc_html__('Soundcloud', 'newsroom'),
            'icon-social-spotify' => esc_html__('Spotify', 'newsroom'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'newsroom'),
            'icon-social-youtube' => esc_html__('Youtube', 'newsroom'),
            'icon-social-dropbox' => esc_html__('Dropbox', 'newsroom')
        );
    }
