...
class NewsroomElatedIconsFontAwesome implements iNewsroomElatedIconCollection
{
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            '' => '',
            'fa-500px' => esc_html__('500px', 'newsroom'),
            'fa-adn' => esc_html__('ADN', 'newsroom'),
            'fa-amazon' => esc_html__('Amazon', 'newsroom'),
            'fa-android' => esc_html__('Android', 'newsroom'),
            'fa-apple' => esc_html__('Apple', 'newsroom'),
            'fa-behance' => esc_html__('Behance', 'newsroom'),
            'fa-behance-square' => esc_html__('Behance Square', 'newsroom'),
            'fa-bitbucket' => esc_html__('Bitbucket', 'newsroom'),
            'fa-bitcoin' => esc_html__('Bitcoin', 'newsroom'),
            'fa-btc' => esc_html__('BTC', 'newsroom'),
            'fa-css3' => esc_html__('CSS3', 'newsroom'),
            'fa-dribbble' => esc_html__('Dribbble', 'newsroom'),
            'fa-dropbox' => esc_html__('Dropbox', 'newsroom'),
            'fa-facebook' => esc_html__('Facebook', 'newsroom'),
            'fa-flickr' => esc_html__('Flickr', 'newsroom'),
            'fa-foursquare' => esc_html__('Foursquare', 'newsroom'),
            'fa-github' => esc_html__('GitHub', 'newsroom'),
            'fa-github-alt' => esc_html__('GitHub-Alt', 'newsroom'),
            'fa-gittip' => esc_html__('Gittip', 'newsroom'),
            'fa-google-plus' => esc_html__('Google Plus', 'newsroom'),
            'fa-html5' => esc_html__('HTML5', 'newsroom'),
            'fa-instagram' => esc_html__('Instagram', 'newsroom'),
            'fa-linkedin' => esc_html__('LinkedIn', 'newsroom'),
            'fa-linux' => esc_html__('Linux', 'newsroom'),
            'fa-envelope' => esc_html__('Mail', 'newsroom'),
            'fa-envelope-o' => esc_html__('Mail Alt', 'newsroom'),
            'fa-envelope-square' => esc_html__('Mail Square', 'newsroom'),
            'fa-maxcdn' => esc_html__('MaxCDN', 'newsroom'),
            'fa-paypal' => esc_html__('Paypal', 'newsroom'),
            'fa-pinterest' => esc_html__('Pinterest', 'newsroom'),
            'fa-reddit-alien' => esc_html__('Reddit Alien', 'newsroom'),
            'fa-renren' => esc_html__('Renren', 'newsroom'),
            'fa-skype' => esc_html__('Skype', 'newsroom'),
            'fa-stack-exchange' => esc_html__('StackExchange', 'newsroom'),
            'fa-tripadvisor' => esc_html__('Trip Advisor', 'newsroom'),
            'fa-trello' => esc_html__('Trello', 'newsroom'),
            'fa-tumblr' => esc_html__('Tumblr', 'newsroom'),
            'fa-twitter' => esc_html__('Twitter', 'newsroom'),
            'fa-vimeo' => esc_html__('Vimeo', 'newsroom'),
            'fa-vimeo-square' => esc_html__('Vimeo Square', 'newsroom'),
            'fa-vine' => esc_html__('Vine', 'newsroom'),
            'fa-vk' => esc_html__('VK', 'newsroom'),
            'fa-weibo' => esc_html__('Weibo', 'newsroom'),
            'fa-wikipedia-w' => esc_html__('Wikipedia', 'newsroom'),
            'fa-windows' => esc_html__('Windows', 'newsroom'),
            'fa-wordpress' => esc_html__('WordPress', 'newsroom'),
            'fa-xing' => esc_html__('Xing', 'newsroom'),
            'fa-youtube' => esc_html__('YouTube', 'newsroom'),
            'fa-youtube-play' => esc_html__('YouTube Play', 'newsroom'),
        );
    }
