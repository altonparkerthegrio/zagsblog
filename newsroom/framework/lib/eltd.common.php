...
$newsroom_options_texttransform = array(
    'none' => esc_html__('None', 'newsroom'),
    'capitalize' => esc_html__('Capitalize', 'newsroom'),
    'uppercase' => esc_html__('Uppercase', 'newsroom'),
    'lowercase' => esc_html__('Lowercase', 'newsroom')
);

$newsroom_options_fontdecoration = array(
    'none' => esc_html__('None', 'newsroom'),
    'underline' => esc_html__('Underline', 'newsroom')
);

$newsroom_options_arrows_type = array(
...
$newsroom_options_double_arrows_type = array(
    'fa fa-angle-double-' => 'fa-angle-double',
    'arrow_carrot-2' => 'arrow_carrot-2',
    'arrow_carrot-2left_alt2' => 'arrow_carrot 2 alt2',
    'icon-arrows-left-double-32' => 'icon-arrows double',
...
$newsroom_options_arrows_up_type = array(
