		...
		<div class="eltd-post-text">
			<div class="eltd-post-text-inner clearfix">
				...
				<div class="eltd-post-title">
					<h2 class="eltd-link-text"><span><?php the_title(); ?></span></h2>
				</div>

				<a itemprop="url" class="eltd-post-link-link" href="<?php echo esc_url(get_post_meta(get_the_ID(), "eltd_post_link_link_meta", true)); ?>" title="<?php the_title_attribute(); ?>"></a>
			</div>
		</div>
