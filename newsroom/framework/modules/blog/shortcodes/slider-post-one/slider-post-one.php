<?php
namespace Newsroom\Modules\Blog\Shortcodes\SliderPostOne;
...
class SliderPostOne extends ListShortcode
{
    ...
    public function __construct() {
        $this->base = 'eltd_slider_post_one';
        $this->css_class = 'eltd-sp-one';
        $this->shortcode_title = esc_html__('Elated Post Slider 1', 'newsroom');
