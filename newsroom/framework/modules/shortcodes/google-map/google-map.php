<?php
namespace Newsroom\Modules\GoogleMap;
...
class GoogleMap implements ShortcodeInterface
{
    ...
    public function vcMap() {
        ...
        vc_map(
            array(
                'name' => esc_html__('Elated Google Map', 'newsroom'),
                'base' => $this->base,
                'category' => 'by ELATED',
                ...
                'params' => array(
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Address 1', 'newsroom'),
                        'param_name' => 'address1',
                        'admin_label' => true
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Address 2', 'newsroom'),
                        'param_name' => 'address2',
                        'admin_label' => true,
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Address 3', 'newsroom'),
                        'param_name' => 'address3',
                        'admin_label' => true,
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Address 4', 'newsroom'),
                        'param_name' => 'address4',
                        'admin_label' => true,
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Address 5', 'newsroom'),
                        'param_name' => 'address5',
                        'admin_label' => true,
                    ...
                    array(
                        'type' => 'dropdown',
                        'heading' => esc_html__('Custom Map Style', 'newsroom'),
                        ...
                        'save_always' => true,
                        'description' => esc_html__('Enabling this option will allow Map editing', 'newsroom')
                    ),
                    array(
                        'type' => 'colorpicker',
                        'heading' => esc_html__('Color Overlay', 'newsroom'),
                        'param_name' => 'color_overlay',
                        'description' => esc_html__('Choose a Map color overlay', 'newsroom'),
                        'dependency' => Array('element' => 'custom_map_style', 'value' => array('true'))
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Saturation', 'newsroom'),
                        'param_name' => 'saturation',
                        'description' => esc_html__('Choose a level of saturation (-100 = least saturated, 100 = most saturated)', 'newsroom'),
                        'dependency' => Array('element' => 'custom_map_style', 'value' => array('true'))
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Lightness', 'newsroom'),
                        'param_name' => 'lightness',
                        'description' => esc_html__('Choose a level of lightness (-100 = darkest, 100 = lightest)', 'newsroom'),
                        'dependency' => Array('element' => 'custom_map_style', 'value' => array('true'))
                    ),
                    array(
                        'type' => 'attach_image',
                        'heading' => esc_html__('Pin', 'newsroom'),
                        'param_name' => 'pin',
                        'description' => esc_html__('Select a pin image to be used on Google Map', 'newsroom')
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Map Zoom', 'newsroom'),
                        'param_name' => 'zoom',
                        'description' => esc_html__('Enter a zoom factor for Google Map (0 = whole worlds, 19 = individual buildings)', 'newsroom')
                    ),
                    array(
                        'type' => 'dropdown',
                        'heading' => esc_html__('Zoom Map on Mouse Wheel', 'newsroom'),
                        ...
                        'save_always' => true,
                        'description' => esc_html__('Enabling this option will allow users to zoom in on Map using mouse wheel', 'newsroom')
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__('Map Height', 'newsroom'),
    ...
    public function render($atts, $content = null) {
        ...
        $html = newsroom_elated_get_shortcode_module_template_part('templates/google-map-template', 'google-map', '', $params);
