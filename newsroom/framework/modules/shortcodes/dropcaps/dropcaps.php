<?php
namespace Newsroom\Modules\Dropcaps;
...
class Dropcaps implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = newsroom_elated_get_shortcode_module_template_part('templates/dropcaps-template', 'dropcaps', '', $params);
	...
	private function getDropcapsClass($params) {
		return ($params['type'] !== '') ? 'eltd-'.$params['type'] : '';
	}
}