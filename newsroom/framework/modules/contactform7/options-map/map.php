...
if (!function_exists('newsroom_elated_contact_form_7_options_map')) {

    function newsroom_elated_contact_form_7_options_map() {

        newsroom_elated_add_admin_page(array(
            'slug' => '_contact_form7_page',
            'title' => esc_html__('Contact Form 7', 'newsroom'),
            'icon' => 'fa fa-envelope-o'
        ));

        $panel_contact_form_style_1 = newsroom_elated_add_admin_panel(array(
            'page' => '_contact_form7_page',
            'name' => 'panel_contact_form_style_1',
            'title' => esc_html__('Custom Style 1', 'newsroom')
        ));

        //Text Typography

        $typography_text_group = newsroom_elated_add_admin_group(array(
            'name' => 'typography_text_group',
            'title' => esc_html__('Form Text Typography', 'newsroom'),
            'description' => esc_html__('Setup typography for form elements text', 'newsroom'),
            'parent' => $panel_contact_form_style_1
        ));

        $typography_text_row1 = newsroom_elated_add_admin_row(array(
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Focus Text Color', 'newsroom'),
        ));
        ...
        $typography_text_row2 = newsroom_elated_add_admin_row(array(
        ...
        $typography_text_row3 = newsroom_elated_add_admin_row(array(
        ...
        $typography_label_group = newsroom_elated_add_admin_group(array(
            'name' => 'typography_label_group',
            'title' => esc_html__('Form Label Typography', 'newsroom'),
            'description' => esc_html__('Setup typography for form elements label', 'newsroom'),
            'parent' => $panel_contact_form_style_1
        ));

        $typography_label_row1 = newsroom_elated_add_admin_row(array(
        ...
        $typography_label_row2 = newsroom_elated_add_admin_row(array(
        ...
        $background_border_group = newsroom_elated_add_admin_group(array(
            'name' => 'background_border_group',
            'title' => esc_html__('Form Elements Background and Border', 'newsroom'),
            'description' => esc_html__('Setup form elements background and border style', 'newsroom'),
            'parent' => $panel_contact_form_style_1
        ));

        $background_border_row1 = newsroom_elated_add_admin_row(array(
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Background Transparency', 'newsroom'),
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Focus Background Color', 'newsroom')
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Focus Background Transparency', 'newsroom')
        ));

        $background_border_row2 = newsroom_elated_add_admin_row(array(
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Border Transparency', 'newsroom'),
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Focus Border Color', 'newsroom')
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Focus Border Transparency', 'newsroom')
        ));

        $background_border_row3 = newsroom_elated_add_admin_row(array(
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Border Width', 'newsroom'),
            'args' => array(
                'suffix' => 'px'
            )
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Border Radius', 'newsroom'),
            'args' => array(
                'suffix' => 'px'
            )
        ));
        ...
        $padding_group = newsroom_elated_add_admin_group(array(
            'name' => 'padding_group',
            'title' => esc_html__('Elements Padding', 'newsroom'),
            'description' => esc_html__('Setup form elements padding', 'newsroom'),
            'parent' => $panel_contact_form_style_1
        ));

        $padding_row = newsroom_elated_add_admin_row(array(
            'name' => 'padding_row',
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Padding Top', 'newsroom'),
            'args' => array(
                'suffix' => 'px'
            )
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Padding Right', 'newsroom'),
            'args' => array(
                'suffix' => 'px'
            )
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Padding Bottom', 'newsroom'),
            'args' => array(
                'suffix' => 'px'
            )
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Padding Left', 'newsroom'),
            'args' => array(
                'suffix' => 'px'
            )
        ));
        ...
        $margin_group = newsroom_elated_add_admin_group(array(
            'name' => 'margin_group',
            'title' => esc_html__('Elements Margin', 'newsroom'),
            'description' => esc_html__('Setup form elements margin', 'newsroom'),
            'parent' => $panel_contact_form_style_1
        ));

        $margin_row = newsroom_elated_add_admin_row(array(
            'name' => 'margin_row',
            'parent' => $margin_group
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Margin Top', 'newsroom'),
            'args' => array(
                'suffix' => 'px'
            )
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Margin Bottom', 'newsroom'),
            'args' => array(
                'suffix' => 'px'
            )
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Textarea Height', 'newsroom'),
            'description' => esc_html__('Enter height for textarea form element', 'newsroom'),
            'args' => array(
                'col_width' => '3',
                'suffix' => 'px'
            )
        ...
        $button_typography_group = newsroom_elated_add_admin_group(array(
            'name' => 'button_typography_group',
            'title' => esc_html__('Button Typography', 'newsroom'),
            'description' => esc_html__('Setup button text typography', 'newsroom'),
            'parent' => $panel_contact_form_style_1
        ));

        $button_typography_row1 = newsroom_elated_add_admin_row(array(
        ...
        $button_typography_row2 = newsroom_elated_add_admin_row(array(
        ...
        $button_background_border_group = newsroom_elated_add_admin_group(array(
            'name' => 'button_background_border_group',
            'title' => esc_html__('Button Background and Border', 'newsroom'),
            'description' => esc_html__('Setup button background and border style', 'newsroom'),
            'parent' => $panel_contact_form_style_1
        ));

        $button_background_border_row1 = newsroom_elated_add_admin_row(array(
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Background Hover Color', 'newsroom')
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Background Hover Transparency', 'newsroom')
        ));

        $button_background_border_row2 = newsroom_elated_add_admin_row(array(
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Border Hover Color', 'newsroom')
        ));
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Border Hover Transparency', 'newsroom')
        ));

        $button_background_border_row3 = newsroom_elated_add_admin_row(array(
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Button Height', 'newsroom'),
            'description' => esc_html__('Insert form button height', 'newsroom'),
            'args' => array(
                'col_width' => '3',
                'suffix' => 'px'
            )
        ...
        newsroom_elated_add_admin_field(array(
            ...
            'default_value' => '',
            'label' => esc_html__('Button Left/Right Padding', 'newsroom'),
            'description' => esc_html__('Enter value for button left and right padding', 'newsroom'),
            'args' => array(
                'col_width' => '3',
                'suffix' => 'px'
            )
        ...
        $panel_contact_form_style_2 = newsroom_elated_add_admin_panel(array(
            'page' => '_contact_form7_page',
            'name' => 'panel_contact_form_style_2',
            'title' => esc_html__('Custom Style 2', 'newsroom')
        ));
    ...
    add_action('newsroom_elated_options_map', 'newsroom_elated_contact_form_7_options_map', 21);
}