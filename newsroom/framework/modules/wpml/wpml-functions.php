...
if(!function_exists('newsroom_elated_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function newsroom_elated_get_wpml_pages_for_current_page() {
		$wpml_pages_for_current_page = array();

		if(newsroom_elated_is_wpml_installed()) {
...
if(!function_exists('newsroom_elated_disable_wpml_css')) {
    function newsroom_elated_disable_wpml_css() {
	    define('ICL_DONT_LOAD_LANGUAGE_SELECTOR_CSS', true);
    }

	add_action('after_setup_theme', 'newsroom_elated_disable_wpml_css');
}