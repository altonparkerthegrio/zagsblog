 ...
 * Class PostLayoutOne
 */
class NewsroomElatedPostLayoutOne extends NewsroomElatedWidget
{
    /**
    ...
    public function __construct() {
        parent::__construct(
            'eltd_post_layout_one_widget', // Base ID
            esc_html__('Elated Post Layout One Widget', 'newsroom') // Name
        );
    ...
    protected function setParams() {
        $this->params = array(
            ...
            array(
                'type' => 'dropdown',
                'title' => esc_html__('Post Type Icon Size', 'newsroom'),
                'name' => 'post_type_icon_size',
                'options' => array(
                    'small' => esc_html__('Small', 'newsroom'),
    ...
    public function widget($args, $instance) {
        ...
        echo '<div class="widget eltd-plw-one">';
        ...
        echo '</div>'; //close div.eltd-plw-one
    }
}