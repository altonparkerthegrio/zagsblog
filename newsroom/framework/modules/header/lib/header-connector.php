<?php
namespace Newsroom\Modules\Header\Lib;
/**
...
class HeaderConnector {
    ...
    public function connect($config = array()) {
        do_action('newsroom_elated_pre_header_connect');
        ...
        if(!empty($config['affect_content'])) {
            add_filter('newsroom_elated_content_elem_style_attr', array($this, 'contentMarginFilter'));
        }

        if(!empty($config['affect_title'])) {
            add_filter('newsroom_elated_title_content_padding', array($this, 'titlePaddingFilter'));
        }

        do_action('newsroom_elated_after_header_connect');
    }
     ...
     *
     * Hooks to newsroom_elated_title_content_padding filter
     *
     * @return int
     */
