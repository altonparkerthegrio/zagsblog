...
include_once ELATED_FRAMEWORK_MODULES_ROOT_DIR . '/header/options-map/mobile-header.php';

//header types
include_once ELATED_FRAMEWORK_MODULES_ROOT_DIR . '/header/types/header-type3.php';
