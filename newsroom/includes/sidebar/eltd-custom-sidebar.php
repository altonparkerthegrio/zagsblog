...
if (!class_exists('NewsroomElatedSidebar')) {

    class NewsroomElatedSidebar
    {
        ...
        function __construct() {
            ...
            $this->title = esc_html__('Custom Widget Area', 'newsroom');
        ...
        function template_add_widget_field() {
            ...
            echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '" . esc_html__('Enter Name of the new Widget Area', 'newsroom') . "' name='eltd-add-widget' /></span>";
            echo "\n    <input class='button' type='submit' value='" . esc_html__('Add Widget Area', 'newsroom') . "' />";
            echo "\n    " . $nonce;
            echo "\n  </form>";
            echo "\n</script>\n";
        }
        ...
        function add_sidebar_area() {
            if (!empty($_POST['eltd-add-widget'])) {
                ...
                $name = rtrim($this->get_name($_POST['eltd-add-widget']));
        ...
        function register_custom_sidebars() {
            ...
            $args = apply_filters('newsroom_elated_custom_widget_args', $args);
