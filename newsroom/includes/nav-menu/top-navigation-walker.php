 ...
 */
if (!class_exists('NewsroomElatedTopNavigationWalker')) {
	class NewsroomElatedTopNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				$angle_icon   = '';
				if($depth !== 0) {
					$angle_icon = '<i class="eltd_menu_arrow arrow_carrot-right"></i>';
				}
