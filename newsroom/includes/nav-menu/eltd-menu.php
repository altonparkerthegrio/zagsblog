...
add_filter( 'wp_setup_nav_menu_item', 'newsroom_elated_add_custom_nav_fields');

// save menu custom fields
add_action( 'wp_update_nav_menu_item', 'newsroom_elated_update_custom_nav_fields', 10, 3 );

// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'newsroom_elated_edit_walker', 10, 2 );


function newsroom_elated_add_custom_nav_fields( $menu_item ) {
 ...
 * @return      void
*/
function newsroom_elated_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
		
	$check = array('anchor', 'nolink', 'hide', 'type_menu', 'icon', 'icon_pack', 'sidebar', 'wide_position', 'background_image');
 ...
 * @return      void
*/
function newsroom_elated_edit_walker($walker,$menu_id) {

	return 'NewsroomElated_Walker_Nav_Menu_Edit_Custom';	
}
