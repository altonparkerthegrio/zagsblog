<?php
$blog_archive_pages_classes = newsroom_elated_blog_archive_pages_classes(newsroom_elated_get_author_blog_list());
?>
<?php get_header(); ?>
...
<?php do_action('newsroom_elated_after_container_open'); ?>
	<div class="<?php echo esc_attr($blog_archive_pages_classes['inner']); ?>">
		<?php newsroom_elated_get_blog(newsroom_elated_get_author_blog_list()); ?>
	</div>
